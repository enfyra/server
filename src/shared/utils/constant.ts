...
export const BOOTSTRAP_SCRIPT_RELOAD_EVENT_KEY =
  'enfyra:bootstrap-script-reload';
...
export const STORAGE_CONFIG_CACHE_SYNC_EVENT_KEY =
  'enfyra:storage-config-cache-sync';
...
export const OAUTH_CONFIG_CACHE_SYNC_EVENT_KEY =
  'enfyra:oauth-config-cache-sync';
